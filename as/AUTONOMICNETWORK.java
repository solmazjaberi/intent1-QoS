	...
	extends Thread
{
	...
	private  AUTONOMICNETWORK (  )
	{
		...
		ACTIONS.put( "CONFIGURATION", generatedbyassl.as.autonomicnetwork.actions.CONFIGURATION.getInstance() );
		ACTIONS.put( "CONFIGUREAUTONOMICNETWORK", generatedbyassl.as.autonomicnetwork.actions.CONFIGUREAUTONOMICNETWORK.getInstance() );
		EVENTS.put( "TIMETOCONFIGURATION", generatedbyassl.as.autonomicnetwork.events.TIMETOCONFIGURATION.getInstance() );
		EVENTS.put( "CONFIGURATIONDONE", generatedbyassl.as.autonomicnetwork.events.CONFIGURATIONDONE.getInstance() );
		EVENTS.put( "CONFIGURATIONDENIED", generatedbyassl.as.autonomicnetwork.events.CONFIGURATIONDENIED.getInstance() );
		AES.put( "CONTROLLER", generatedbyassl.as.aes.CONTROLLER.getInstance() );
		AES.put( "GOLDLEVELSUBSCRIBER", generatedbyassl.as.aes.GOLDLEVELSUBSCRIBER.getInstance() );
	}
