 ...
 * 
 * This is the Java class generated for 'QoSGold' (specified as ACTION ASSL tier).
 */
	...
	implements  Serializable
{
	...
	public boolean GUARDS (  )
	{
		...
		bResult =  generatedbyassl.as.aes.goldlevelsubscriber.aeself_management.qosgold.INQOSGOLD.getInstance().isFluentInitiated()  ;
		return bResult;
	}
	...
	{
		super.DOES();
		generatedbyassl.as.aes.goldlevelsubscriber.aeip.functions.RECEIVEMSGQOSGOLD.getInstance().perform(  );
	}
	...
	{
		generatedbyassl.as.aes.goldlevelsubscriber.events.QOSINITIATED.getInstance().triggerEvent();
	}
