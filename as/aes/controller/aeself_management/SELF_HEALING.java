	...
	implements  Serializable
{
	...
	{
		vFluents.put( "INRECONFIGURATION", generatedbyassl.as.aes.controller.aeself_management.self_healing.INRECONFIGURATION.getInstance() );
	}
	...
	{
		//************************ MAPPING ***********************
		if ( generatedbyassl.as.aes.controller.aeself_management.self_healing.INRECONFIGURATION.getInstance().isFluentInitiated() ) 
		{
			...
			Runnable actionsRunner = new Runnable()
			{
				...
				public void run (  )
				{
					try
					{
						generatedbyassl.as.aes.controller.actions.RECONFIGURE.getInstance().perform(  );
					}
					catch ( Exception ex ) 
					{
