	...
	implements  Serializable
{
	...
	private  AEIP (  )
	{
		MESSAGES.put( "MSGQOSGOLD", generatedbyassl.as.aes.controller.aeip.messages.MSGQOSGOLD.getInstance() );
		CHANNELS.put( "GOLDLINK", generatedbyassl.as.aes.controller.aeip.channels.GOLDLINK.getInstance() );
		FUNCTIONS.put( "SENDMSGQOSGOLD", generatedbyassl.as.aes.controller.aeip.functions.SENDMSGQOSGOLD.getInstance() );
		MANAGED_ELEMENTS.put( "MONITORINGTOOL", generatedbyassl.as.aes.controller.aeip.managed_elements.MONITORINGTOOL.getInstance() );
	}
