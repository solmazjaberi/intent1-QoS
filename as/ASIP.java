	...
	implements  Serializable
{
	...
	private  ASIP (  )
	{
		MESSAGES.put( "MONITORINGMESSAGE", generatedbyassl.as.asip.messages.MONITORINGMESSAGE.getInstance() );
		MESSAGES.put( "RECONFIGNOTIFMSG", generatedbyassl.as.asip.messages.RECONFIGNOTIFMSG.getInstance() );
		CHANNELS.put( "PUBLIC_LINK", generatedbyassl.as.asip.channels.PUBLIC_LINK.getInstance() );
		FUNCTIONS.put( "SENDMONITORINGMSG", generatedbyassl.as.asip.functions.SENDMONITORINGMSG.getInstance() );
		FUNCTIONS.put( "SENDRECONFIGNOTIF", generatedbyassl.as.asip.functions.SENDRECONFIGNOTIF.getInstance() );
	}
